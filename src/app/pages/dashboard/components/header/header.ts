...
export class DashboardHeader {
  ...
  protected userAvatar = this.authService.userAvatar;
  ...
  protected menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      description: 'Advogados e Staff'
    },
    {
      label: 'Audiências',
      route: '/dashboard/audiencias',
      ...
      description: 'Agenda de Audiências'
    },
    {
      label: 'Documentos',
    ...
    },
    {
      ...
      description: 'Honorários e Despesas'
    },
    {
      label: 'Relatórios',
